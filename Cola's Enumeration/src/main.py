...
# 
# Author: AndrewJVella https://googology.fandom.com/wiki/User:AndrewJVella
# Published on github at https://github.com/AndrewJVella/Apeironillions
# MIT license
#
...
def menu():
	...
	print("\nCola's Enumeration for Naming Large Numbers, by AndrewJVella.\nBased on Conway's illion Converter, by Fish.")
